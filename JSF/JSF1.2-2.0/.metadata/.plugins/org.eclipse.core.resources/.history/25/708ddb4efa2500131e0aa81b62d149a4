...
<f:selectItem itemLabel="Batch-46" itemValue="A-46" />
<f:selectItem itemLabel="Batch-47" itemValue="B-47" />
<f:selectItem itemLabel="Batch-48" itemValue="C-48" />
<f:selectItem itemLabel="Batch-49" itemValue="D-49" />
<f:selectItem itemLabel="Batch-50" itemValue="E-50" />				 
</h:selectOneMenu>
</h:panelGrid>
